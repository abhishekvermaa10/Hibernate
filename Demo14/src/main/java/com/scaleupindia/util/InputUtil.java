...
public class InputUtil {
	...
	public static int acceptMenuOption(Scanner scanner) {
		...
		System.out.println("Press 6 to fetch all owners where male and female owners are from different city.");
		System.out.println("Press 7 to fetch all owners where owner gender and pet gender is not same.");
	...
	public static String acceptCityOfMaleOwner(Scanner scanner) {
		System.out.println("Enter city of male owner:");
		return scanner.next();
	}

	public static String acceptCityOfFemaleOwner(Scanner scanner) {
		System.out.println("Enter city of female owner:");
		return scanner.next();
	}
